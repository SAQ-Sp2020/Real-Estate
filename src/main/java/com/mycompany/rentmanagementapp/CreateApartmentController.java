 ...
 * @author VarnithaPuli
 */
public class CreateApartmentController implements Initializable {
    ...
    //handler method defined for all the events during apartment creation
    @FXML
    void createApartmentHandler(ActionEvent event) throws IOException {
        ...
        stage.setFullScreenExitHint("");
            ...
            //when create button is clicked, creates a new apartment and adds it to the repo
            try {
                Apartment crib = new Apartment();
                crib.setTypeOfProp("Apartment");
                crib.setDescription(description.getText());
                crib.setAddress(address.getText());
                crib.setCity(city.getText());
                crib.setState(state.getText());
                crib.setPostalCode(postalCode.getText());
                crib.setNumbOfBathrooms(Integer.parseInt(bathrooms.getText()));
                crib.setNumbOfBedrooms(Integer.parseInt(bedrooms.getText()));
                crib.setPropertyPic(new Image(file.toURI().toString()));
                crib.setMinimumLeasePeriod(Integer.parseInt(leasePeriod.getText()));
                crib.setMonthlyFee(Double.parseDouble(monthlyFee.getText()));
                repo.createProperty(crib);
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setHeaderText("Apartment is added");
        ...
        stage.setFullScreenExitHint("");
                ...
                //displays an alert with the stack trace of any execption during apartment creation
                StringWriter sw = new StringWriter();
                PrintWriter pw = new PrintWriter(sw);
                ex.printStackTrace(pw);
                String s = sw.toString();
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setHeaderText("Apartment is not added");
